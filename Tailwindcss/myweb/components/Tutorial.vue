    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <ul class="flex col-auto">
          <li class="mx-2">
            <router-link to="布局">布局</router-link>
          </li>
          <li class="mx-2">
            <router-link to="布局2">布局2</router-link>
          </li>
          <li class="mx-2">
            <router-link to="布局3">布局3</router-link>
          </li>
          <li class="mx-2">
            <router-link to="布局4">布局4</router-link>
          </li>

          <li class="mx-2">
            <router-link to="客製按鈕">客製按鈕</router-link>
          </li>
          <li class="mx-2">
            <router-link to="動畫">動畫</router-link>
          </li>
          <li class="mx-2">
          ...
          <li class="mx-2">
            <router-link to="Responsive_Layout">Responsive_Layout</router-link>
          </li>
          <li class="mx-2">
...
<script>
  import test1 from "../pages/布局.vue";
  export default {
    components: {
      test1,
    },
